...
var _user$project$Type$Flags = F3(
	function (a, b, c) {
		return {lang: a, field: b, $class: c};
	});
var _user$project$Type$Model = F4(
	function (a, b, c, d) {
		return {lang: a, field: b, $class: c, value: d};
	});
var _user$project$Type$FetchFail = function (a) {
...
var _user$project$Helpers$geoServiceUrl = function (model) {
	...
	if (_p0.ctor === 'Nothing') {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'lang', _1: _p0._0}
				]));
	}
};
...
var _user$project$Helpers$getGeoData = function (model) {
	...
	return A3(
		...
		_user$project$Type$FetchFail,
		_user$project$Type$FetchSucceed,
		A2(
...
var _user$project$View$view = function (model) {
	var list = function () {
		...
		if (_p0.ctor === 'Just') {
			return A2(
				_elm_lang$core$List_ops['::'],
				{ctor: '_Tuple2', _0: _p0._0, _1: true},
				_elm_lang$core$Native_List.fromArray(
					[]));
		} else {
			return _elm_lang$core$Native_List.fromArray(
	...
	if (_p1.ctor === 'Nothing') {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$classList(list)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-map-marker')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					...
					return A2(
						...
						function (lang) {
							return _elm_lang$core$Json_Decode$succeed(
								{$class: $class, field: field, lang: lang});
						});
				});
		})
};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['GeoLabel'], 'GeoLabel', typeof _user$project$GeoLabel$main === 'undefined' ? null : _user$project$GeoLabel$main);
