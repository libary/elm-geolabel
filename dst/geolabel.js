...
var _user$project$Type$Flags = F2(
	function (a, b) {
		return {field: a, $class: b};
	});
var _user$project$Type$Model = F3(
	function (a, b, c) {
		return {field: a, $class: b, value: c};
	});
var _user$project$Type$FetchResult = function (a) {
...
var _user$project$Helpers$getGeoData = function (model) {
	var url = _user$project$Helpers$geoServiceUrl(model);
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Type$FetchResult,
		A2(
			_elm_lang$http$Http$get,
			url,
			_user$project$Helpers$decodeGeoData(model)));
};
...
var _user$project$View$view = function (model) {
	var list = function () {
		...
		if (_p0.ctor === 'Just') {
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _p0._0, _1: true},
				_1: {ctor: '[]'}
			};
		} else {
			return {ctor: '[]'};
	...
	if (_p1.ctor === 'Nothing') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(list),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$GeoLabel$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$GeoLabel$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Fetch') {
			return {
			...
			if (_p0._0.ctor === 'Ok') {
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							value: _elm_lang$core$Maybe$Just(_p0._0._0)
						}),
					{ctor: '[]'});
			} else {
				return A2(
...
var _user$project$GeoLabel$init = function (flags) {
	var model = A3(_user$project$Type$Model, flags.field, flags.$class, _elm_lang$core$Maybe$Nothing);
	return A2(_user$project$GeoLabel$update, _user$project$Type$Fetch, model);
};
var _user$project$GeoLabel$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$GeoLabel$init, update: _user$project$GeoLabel$update, view: _user$project$View$view, subscriptions: _user$project$GeoLabel$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function ($class) {
			return A2(
...
var Elm = {};
Elm['GeoLabel'] = Elm['GeoLabel'] || {};
if (typeof _user$project$GeoLabel$main !== 'undefined') {
    _user$project$GeoLabel$main(Elm['GeoLabel'], 'GeoLabel', undefined);
}
